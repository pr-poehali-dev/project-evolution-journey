  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6">
        <p className="uppercase tracking-widest text-blue-400 text-sm mb-4 font-medium">Платформа для развёртывания</p>
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6 leading-tight">
          ДЕПЛОЙ<br />БЕЗ ГРАНИЦ
        </h1>
        <p className="text-lg md:text-xl max-w-2xl mx-auto opacity-90 mb-10">
          Разворачивайте приложения за секунды. CI/CD, автоскейлинг, edge-сеть — всё готово к работе из коробки.
        </p>
